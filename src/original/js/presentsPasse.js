...
//Affichage des présents du passé
...
function parseDatas() {
  ...
  dataSL.forEach((element) => {
    let c = element.split(';') //c0 = durée, c1= Timestamp, c2=ID

    if (parseInt(c[1]) >= tempIn && parseInt(c[1]) < tempOut) {
      let idVN = dataC.filter(function (entry) {
...
//On récupère les bornes du jour
let tempIn, tempOut
...
function recupDate() {
  ...
  const dateControl = document.getElementById('myDate').value

  tempIn = DateToTimestamp(dateControl)
  tempOut = Number(tempIn) + 86400
...
///////////////////////////////////////////////////////////////////////////////
//                   EXPERIMENTAL A TESTER
///////////////////////////////////////////////////////////////////////////////

//charcher les entrées invalides d'un Json
const datasJSON = [
  {
    name: 'canelet',
    price: 15.99,
...
const arrByID = datasJSON.filter(filterByID)
